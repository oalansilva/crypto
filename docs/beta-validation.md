# Validacao do Beta Fechado

## Objetivo

Validar se o Monitor entrega valor real antes de expandir escopo, infraestrutura ou cobranca.

## Publico Inicial

- investidores iniciantes;
- investidores intermediarios;
- traders de swing trade;
- pessoas que sofrem com excesso de informacao, timing ruim ou dificuldade de saber vender.

## Tamanho do Beta

Comecar com 3 a 5 usuarios.

Esse tamanho permite suporte manual, conversa direta e aprendizado rapido sem transformar operacao em atendimento pesado.
...
Cada feedback relevante deve virar pelo menos um dos itens:

- nota na planilha;
- issue no GitHub;
- decisao no `docs/decision-log.md`;
- ajuste no escopo do MVP.

## Regra Comercial

Nao vender promessa de lucro.
