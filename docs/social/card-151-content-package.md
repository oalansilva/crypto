# Pacote Inicial de Conteudo - Card #151

Data: 2026-05-17
Card: #151 `P1: Gerar pacote inicial de conteudo LinkedIn Instagram Telegram`
Status: pronto para revisao do Alan
Base: #147 plano de conteudo, #152 checklist de aprovacao/publicacao piloto e landing atual do beta

## Guardrails Aplicados

- Nenhuma peca promete lucro, acerto, resultado financeiro ou oportunidade garantida.
- Nenhuma peca chama o beta de grupo de sinais.
- Compra, manutencao e venda aparecem como apoio a decisao, nao como ordem operacional.
- Telegram/grupos e WhatsApp/DM dependem de envio manual do Alan e contexto/permissao.
- Publicacao externa continua dependente de aprovacao explicita do Alan.

## Links de Apoio

- Captacao: https://criptofarol.com.br/
- Card: https://github.com/oalansilva/crypto/issues/151
- Galeria das imagens: ./card-151-assets/index.html

## Entregaveis

### LinkedIn 1 - Problema e Tese

Objetivo: explicar a tese com maturidade e abrir conversa qualificada.
...
Imagem sugerida: `card-151-linkedin-1-tese.png`

### LinkedIn 2 - Convite Controlado

Objetivo: convidar interessados da rede do Alan sem parecer venda agressiva.
...
Ainda nao e uma plataforma publica. E um beta fechado para validar se investidores cripto enxergam valor em uma ferramenta que organiza:
...
Imagem sugerida: `card-151-linkedin-2-convite.png`

### Instagram 1 - Carrossel

Formato: 8 slides, 4:5, para leitura mobile.
...
Imagem sugerida: `card-151-instagram-1-carrossel-capa.png`
...
```text
Antes de comprar uma cripto,
voce sabe o que esta olhando?
```
...
Imagem sugerida: `card-151-instagram-2-post-curto.png`

### Telegram/Grupos

Usar somente em grupo onde Alan ja tenha contexto ou permissao.
...
Enviar manualmente, uma pessoa por vez, ajustando o primeiro paragrafo conforme o contexto da relacao.
...
Resposta se a pessoa aceitar:

```text
Boa. O link e este:
https://criptofarol.com.br/

Se voce entrar na lista, depois quero te pedir um feedback direto sobre clareza, utilidade e o que travou.
```

## Ordem Recomendada

1. WhatsApp/DM para 5 a 10 contatos quentes.
2. LinkedIn 1 para validar a tese.
3. Telegram/grupos apenas onde houver permissao/contexto.
4. LinkedIn 2 como convite direto.
5. Instagram como reaproveitamento visual.

## Checklist Antes de Publicar

- [ ] Alan aprovou texto e visual final.
- [ ] Canal e horario definidos.
- [ ] Link de captacao testado no dia.
- [ ] Nenhum texto parece promessa de lucro, call ou recomendacao individual.
- [ ] Publicacao/envio externo feito manualmente por Alan.
