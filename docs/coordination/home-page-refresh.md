...
- @PO/@Alan: please confirm IA + which KPIs should be highlighted on Home.

## Next actions
- [x] PO: Brainstorm and lock IA + acceptance for new Home.
- [x] DESIGN: Create initial HTML/CSS prototype (v0) for new Home.
