                            ...
                            {(() => {
                                ...
                                <div key={paramName} className={`glass-strong p-4 rounded-xl border transition-all ${formErrors[paramName] ? 'border-red-500/50 bg-red-500/5' : 'border-zinc-100'}`}>
                                    ...
                                    <div className="grid grid-cols-3 gap-4">
                                        <div>
                                            <label className="text-[10px] uppercase tracking-wider text-zinc-500 font-bold mb-1 block">Min</label>
                                            <input
                                                type="number"
                                                step={config.step}
                                                value={config.min}
                                        ...
                                        <div>
                                            <label className="text-[10px] uppercase tracking-wider text-zinc-500 font-bold mb-1 block">Max</label>
                                            <input
                                                type="number"
                                                step={config.step}
                                                value={config.max}
                                        ...
                                        <div>
                                            <label className="text-[10px] uppercase tracking-wider text-zinc-500 font-bold mb-1 block">Step</label>
                                            <input
                                                type="number"
                                                value={config.step}
