...
1. Harbor Signal: farol central, onda/horizonte e dois feixes. Melhor para memorabilidade e narrativa de navegacao.
...
Motivo: preserva a metafora do farol e mar, mas deixa o produto mais claro para cripto ao unir horizonte, feixe e leitura de risco. Funciona melhor como app icon e cabe em header sem depender de detalhes pequenos.

## Copy Rationale

- Headline escolhida: "Saiba quando manter uma posicao e quando sair."
- Motivo: conversa diretamente com a dor de timing e venda, sem prometer lucro.
- CTA principal: "Quero entrar no beta".
- CTA final: "Receber acesso ao beta", alinhado a automacao implementada.
