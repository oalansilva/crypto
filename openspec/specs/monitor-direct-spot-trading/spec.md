# monitor-direct-spot-trading Specification

## Purpose
Authenticated Monitor users execute direct Binance Spot purchases and full-balance market sales for USDT pairs from inside Cripto Farol, with explicit review, fail-closed validation, idempotency and safe reconciliation of unknown outcomes.
