# jwt-secret-fail-closed Specification

## Purpose
Fail-closed resolution of `JWT_SECRET` for runtime that signs or validates JWT. Refuse a repository-versioned default so forged HS256 sessions cannot use a public secret.
