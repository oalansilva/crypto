# admin-backfill-surface-removal Specification

## Purpose
Remove the discontinued Admin Backfill UI/API surface while preserving programmatic OHLCV backfill used by market candles.
