...
- [ ] **T1 — `OpportunityCard.tsx`: estender `<dl class="kv">` para HOLD com hierarquia risco**
...
- [ ] **T2 — Frase de cenário condicionada**
...
- [ ] **T3 — EXIT: esconder Entry/Stop operáveis e mostrar risco residual**
...
- [ ] **T4 — Coerência com modal do gráfico**
...
- [ ] **T5 — `is_strategy_protected=true` não vaza segredo**
...
- [ ] **T6 — Playwright + unit: 5 cenários do issue**
