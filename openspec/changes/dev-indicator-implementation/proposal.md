...
- Permitir que o Dev **crie/edite indicadores** no backend (ex.: qualquer indicador do `pandas_ta`).
...
- Dev consegue adicionar indicador novo (ex.: qualquer indicador do pandas_ta) sem tocar no frontend.
