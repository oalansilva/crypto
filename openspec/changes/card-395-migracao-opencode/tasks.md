...
- [x] 1.1 Atualizar `~/.config/opencode/opencode.jsonc` com model `opencode-go/deepseek-v4-flash` e MCP `openaiDeveloperDocs`.
...
- [x] 2.1 Criar `opencode.json` na raiz ($schema, model, instructions, MCP openaiDeveloperDocs, plugin impeccable).
