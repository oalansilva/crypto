...
- [x] 1.1 Extend monitor preferences schema to include `theme` (default: `dark-green`)
- [x] 1.2 Update preferences endpoints to read/write theme
- [x] 1.3 Add SQLite migration/ensure-migration for the new column
- [x] 1.4 Add backend integration tests for theme preference
...
- [x] 4.1 Run `openspec validate monitor-dark-green-theme --type change`
