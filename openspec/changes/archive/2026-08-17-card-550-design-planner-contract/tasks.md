...
- [x] 8.3 Integrar a entrega aprovada em `develop` conforme o processo, executar `./restart`, validar o runtime em processo novo e exportar evidence bytes/digest/verifier result correlacionados para desbloquear o trabalho separado do #555.
