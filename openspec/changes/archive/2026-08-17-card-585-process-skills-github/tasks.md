# Tasks: card-585-process-skills-github

## Design (este turno)

- [x] 0.1 OpenSpec + crítica; Gist no card; `design.md` superset do issue #585

## Apply (após Pronto para Dev)

- [x] 1. Copiar 3 skills (`SKILL.md`, `scripts/`, `references/`; sem `agents/openai.yaml`) para `.cursor/skills/` como arquivos reais
