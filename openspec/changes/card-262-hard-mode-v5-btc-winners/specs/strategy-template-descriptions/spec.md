...
Every new strategy key introduced for issue #262 SHALL resolve to a specific public display name and strategy description before saving and after served API readback.

#### Scenario: Public identity is validated before save
- **WHEN** issue #262 prepares a candidate for saving as a winner
- **THEN** the execution SHALL define `name`, `strategy_name`, `strategy_display_name`, `strategy_description`, and the public mapping source
