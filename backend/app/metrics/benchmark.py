...
def calculate_buy_and_hold(prices: pd.Series, initial_capital: float) -> dict:
    ...
    """
    if len(prices) < 2:
        return {"return_pct": 0.0, "cagr": 0.0, "final_value": initial_capital}
    ...
    return {"return_pct": return_pct, "cagr": cagr, "final_value": final_value}
...
def calculate_correlation(strategy_returns: pd.Series, benchmark_returns: pd.Series) -> float:
    """
