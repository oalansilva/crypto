...
def seed_example_templates(db_path: str = None):
    ...
    examples = [
            ...
            "template_data": {
                "indicators": [
                    ...
                    },
                    {
                        ...
                        "alias": "long",
                        "params": {"length": 37},
                        "optimization_range": {"min": 30, "max": 50, "step": 1},
                    },
                    {
                        "type": "sma",
                        "alias": "inter",
                        "params": {"length": 32},
                        "optimization_range": {"min": 20, "max": 40, "step": 1},
                    },
                ],
        ...
        },
        {
            ...
            "template_data": {
                "indicators": [
                    {
                        ...
                        "alias": "fast",
                        "params": {"length": 5},
                        "optimization_range": {"min": 3, "max": 10, "step": 1},
                    },
                    {
                        "type": "ema",
                        "alias": "slow",
                ...
                "stop_loss": {
                    "default": 0.01,
                    "optimization_range": {"min": 0.005, "max": 0.015, "step": 0.0025},
                },
            },
        },
        {
            ...
            "template_data": {
                ...
                "stop_loss": {
                    "default": 0.02,
                    "optimization_range": {"min": 0.01, "max": 0.03, "step": 0.005},
                },
            },
        },
        {
            ...
            "template_data": {
                "indicators": [
                    {
                        ...
                        "alias": "vol_avg",
                        "params": {"length": 20},
                        "optimization_range": {"min": 10, "max": 30, "step": 5},
                    }
                ],
                ...
                "stop_loss": {
                    "default": 0.015,
                    "optimization_range": {"min": 0.01, "max": 0.025, "step": 0.005},
                },
            },
        },
    ]
    ...
    for example in examples:
        cursor.execute(
            ...
            VALUES (?, ?, 1, 0, ?)
        """,
            (example["name"], example["description"], json.dumps(example["template_data"])),
        )
