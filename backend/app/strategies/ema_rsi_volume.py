...
class EmaRsiVolumeStrategy:
    ...
    def __init__(self, config: dict):
        ...
        logger.info(
            f"EMA_RSI_VOLUME initialized: ema_fast={self.ema_fast}, ema_slow={self.ema_slow}, "
    ...
    def generate_signals(self, df: pd.DataFrame) -> pd.Series:
        ...
        logger.info(
            f"EMA_RSI_VOLUME generated {buy_condition.sum()} buy signals and {sell_condition.sum()} sell signals"
        )
